...
Вся инструкция (включая настройку переменных среды) находится здесь: <a href="./TASK.md">TASK.md</a>
...
3. Первые ~50 отзывов уже лежат прямо в HTML страницы при загрузке — забираем их сразу, без
   скролла.
